...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 29-03-2025 a las 04:16:05
...
INSERT INTO `sigt_salida` (`ID_SALIDA`, `ID_COLABORADOR_SACANDO`, `ID_COLABORADOR_RECIBIENDO`, `FEC_SALIDA`, `ID_USUARIO`, `ESTADO`) VALUES
(1, 1, 2, '2025-03-01 00:00:00', 1, 1),
(2, 2, 3, '2025-03-02 00:00:00', 2, 1),
(3, 3, 4, '2025-03-03 00:00:00', 3, 1),
(4, 4, 5, '2025-03-04 00:00:00', 4, 1),
(5, 5, 6, '2025-03-05 00:00:00', 5, 1),
(6, 6, 7, '2025-03-06 00:00:00', 6, 1),
(7, 7, 8, '2025-03-07 00:00:00', 7, 1),
(8, 8, 9, '2025-03-08 00:00:00', 8, 1),
(9, 9, 10, '2025-03-09 00:00:00', 9, 1),
(10, 10, 11, '2025-03-10 00:00:00', 10, 1);
...
--
ALTER TABLE `sigm_entidad_financiera`
  MODIFY `ID_ENTIDAD_FINANCIERA` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=31;
...
--
ALTER TABLE `sigt_factura_producto`
  MODIFY `ID_FACTURA_PRODUCTO` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=44;
...
--
ALTER TABLE `sigt_salida_producto`
  MODIFY `ID_SALIDA_PRODUCTO` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;
