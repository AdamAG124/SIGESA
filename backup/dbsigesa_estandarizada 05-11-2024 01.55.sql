...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 05-11-2024 a las 08:54:58
...
(1, 'Electrónica', 'Dispositivos electrónicos y accesorios', 1),
...
(22, 'Verduras', 'Todo tipo de verduras', 1),
(23, 'Vegetales', 'Todo tipo de vegetales', 1),
(24, 'Granos', 'Todo tipo de granos, como el arroz.', 0);
...
CREATE TABLE `sigm_colaborador` (
  ...
  `DSC_SEGUNDO_APELLIDO` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `FEC_NACIMIENTO` date DEFAULT NULL,
  `NUM_TELEFONO` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `FEC_INGRESO` date DEFAULT NULL,
  `FEC_SALIDA` date DEFAULT NULL,
  `ESTADO` tinyint(1) DEFAULT NULL,
  `DSC_CORREO` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `DSC_CEDULA` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `DSC_NOMBRE` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `DSC_PRIMER_APELLIDO` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `sigm_comprobante_pago` (
  ...
  `NUM_COMPROBANTE_PAGO` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `sigm_cuenta_bancaria` (
  ...
  `ID_ENTIDAD_FINANCIERA` int DEFAULT NULL,
  `DSC_BANCO` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `NUM_CUENTA_BANCARIA` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `TIPO_DIVISA` varchar(10) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `ESTADO` tinyint(1) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `sigm_departamento` (
  ...
  `DSC_NOMBRE_DEPARTAMENTO` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `DSC_DEPARTAMENTO` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `ESTADO` tinyint(1) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `sigm_entidad_financiera` (
  ...
  `DSC_NOMBRE_ENTIDAD_FINANCIERA` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `TIPO_ENTIDAD_FINANCIERA` varchar(25) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `ESTADO` tinyint(1) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `sigm_factura` (
  ...
  `NUM_FACTURA` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `FEC_FACTURA` date DEFAULT NULL,
  `DSC_DETALLE_FACTURA` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
...
CREATE TABLE `sigm_producto` (
  ...
  `DSC_NOMBRE` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `DSC_PRODUCTO` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `NUM_CANTIDAD` double DEFAULT NULL,
  `DSC_UNIDAD_MEDICION` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `ESTADO` tinyint(1) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `sigm_proveedor` (
  ...
  `DSC_NOMBRE` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `DSC_PROVINCIA` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `DSC_CANTON` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `DSC_DISTRITO` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `DSC_DIRECCION` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `ESTADO` tinyint(1) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
(16, 'Proveedor Quince', 'San José', 'Moravia', 'La Trinidad', 'Calle 15, Avenida 16', 1),
...
CREATE TABLE `sigm_puesto_trabajo` (
  ...
  `DSC_NOMBRE` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `DSC_PUESTO_TRABAJO` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `ESTADO` tinyint(1) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `sigm_rol` (
  `ID_ROL` int NOT NULL,
  `DSC_NOMBRE` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `DSC_ROL` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `sigm_usuario` (
  ...
  `DSC_PASSWORD` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `ESTADO` tinyint(1) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
--
ALTER TABLE `sigm_categoria_producto`
  MODIFY `ID_CATEGORIA_PRODUCTO` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=25;
