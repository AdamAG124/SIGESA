...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 23-04-2025 a las 19:53:12
...
--
-- Volcado de datos para la tabla `sigm_cuenta_bancaria`
--

INSERT INTO `sigm_cuenta_bancaria` (`ID_CUENTA_BANCARIA`, `ID_ENTIDAD_FINANCIERA`, `DSC_BANCO`, `NUM_CUENTA_BANCARIA`, `TIPO_DIVISA`, `ESTADO`) VALUES
(1, 1, 'Banco de América', '1234567890123456', 'CRC', 1),
(2, 2, 'BBVA', '9876543210987654', 'CRC', 1),
(3, 3, 'Santander', '4567891234567890', 'USD', 1),
(4, 4, 'Citibank', '3216549871234567', 'USD', 1),
(5, 5, 'HSBC', '7894561239876543', 'USD', 1),
(6, 6, 'Banamex', '6549873214567890', 'CRC', 1),
(7, 7, 'Chase Bank', '1472583690123456', 'USD', 0),
(8, 8, 'Deutsche Bank', '2583691478529630', 'CRC', 1),
(9, 9, 'Scotiabank', '3692581479638520', 'CRC', 1),
(10, 10, 'Wells Fargo', '8529637410852963', 'CRC', 1),
(11, 11, 'Banorte', '7418529630123456', 'CRC', 1),
(12, 12, 'Bank of Tokyo', '9638527410123456', 'CRC', 1),
(13, 13, 'ING Bank', '1597534862012345', 'CRC', 1),
(14, 14, 'Banco Azteca', '3579514862041536', 'USD', 0),
(15, 15, 'Standard Chartered', '9517534862041536', 'CRC', 1),
(16, 16, 'Banco Popular', '7539514862041536', 'CRC', 1),
(17, 17, 'Barclays', '4561237896541230', 'USD', 1),
(18, 18, 'Itaú', '7894561230123456', 'USD', 1),
(19, 19, 'Banco de Chile', '1237894560123456', 'USD', 1),
(20, 20, 'Bancolombia', '4561237890123456', 'USD', 1),
(21, 21, 'Credit Suisse', '7891234560123456', 'CRC', 0),
(22, 22, 'Banco Galicia', '3216549870123456', 'USD', 1),
(23, 23, 'CaixaBank', '6549873210123456', 'CRC', 1),
(24, 24, 'Banco do Brasil', '9876543210123456', 'USD', 1),
(25, 25, 'RBC Bank', '1472583690123456', 'USD', 1),
(26, 26, 'Bancomext', '2583691470123456', 'USD', 1),
(27, 27, 'ANZ Bank', '3692581470123456', 'CRC', 1),
(28, 28, 'Nordea Bank', '8529637410123456', 'CRC', 1),
(29, 29, 'Banco Pichincha', '7418529630123456', 'CRC', 0),
(30, 30, 'UniCredit', '9638527410123456', 'USD', 1);
...
CREATE TABLE `sigm_entidad_financiera` (
  ...
  `DSC_TELEFONO_ENTIDAD_FINANCIERA` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `DSC_CORREO_ENTIDAD_FINANCIERA` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
(29, 'Cooperativa Horizonte', NULL, NULL, 'Cooperativa', NULL, 1),
(30, 'PayTech', NULL, NULL, 'Fintech', NULL, 1),
(31, 'Banco Popular', '89456123', 'bpn@sarapiqui.com', 'Banco', NULL, 1);
...
(1, 8, 'Laptop ASUS VivoBook 123', 'Laptop ligera, 8GB RAM, SSD 256GB', 10, 9, 1),
(2, 2, 'Monitor Dell 27\"', 'Monitor Dell UltraSharp 27\" 4K UHD', 15, 4, 0),
(3, 3, 'Teclado Logitech', 'Teclado inalámbrico Logitech MX Keys', 51, 6, 1),
(4, 4, 'Mouse Logitech', 'Mouse inalámbrico Logitech MX Master 3', 61, 8, 0),
(5, 5, 'Impresora Epson', 'Impresora multifuncional Epson EcoTank L3150', 10, 1, 1),
(6, 6, 'Cartucho HP 664', 'Cartucho de tinta HP 664 Negro', 200, 3, 1),
(7, 7, 'Router TP-Link', 'Router Wi-Fi TP-Link Archer C6 AC1200', 30, 8, 1),
(8, 8, 'Disco Duro 1TB', 'Disco duro externo Seagate 1TB USB 3.0', 41, 3, 1),
(9, 9, 'Memoria USB 64GB', 'Memoria USB Kingston DataTraveler 64GB', 175, 1, 1),
(10, 10, 'Cámara Web Logitech', 'Cámara web Logitech C920 HD Pro', 21, 4, 1),
(11, 11, 'Auriculares Sony', 'Auriculares Sony WH-1000XM4 con cancelación de ruido', 37, 9, 1),
(12, 12, 'Silla Ergonómica', 'Silla ergonómica de oficina ajustable', 13, 9, 1),
(13, 13, 'Escritorio de Madera', 'Escritorio de madera 120x60 cm', 8, 10, 1),
(14, 14, 'Lámpara LED', 'Lámpara de escritorio LED regulable', 25, 1, 1),
(15, 15, 'Papel A4', 'Resma de papel A4 500 hojas', 107, 3, 1),
(16, 16, 'Bolígrafo Bic', 'Bolígrafo Bic Cristal negro', 500, 3, 1),
(17, 17, 'Cuaderno Espiral', 'Cuaderno espiral 100 hojas cuadriculado', 80, 6, 1),
(18, 18, 'Archivador', 'Archivador de palanca tamaño oficio', 80, 9, 1),
(19, 19, 'Calculadora Casio', 'Calculadora científica Casio FX-991ES', 30, 5, 1),
(20, 20, 'Proyector Epson', 'Proyector Epson EB-X05 3300 lúmenes', 5, 1, 1),
(21, 21, 'Pizarra Blanca', 'Pizarra blanca magnética 90x60 cm', 15, 9, 1),
(22, 22, 'Marcadores', 'Juego de 4 marcadores para pizarra', 50, 9, 1),
(23, 23, 'Cargador USB', 'Cargador USB de pared 20W', 100, 9, 1),
(24, 24, 'Cable HDMI', 'Cable HDMI 2.0 de 3 metros', 75, 6, 1),
(25, 25, 'Batería AA', 'Paquete de 10 baterías AA recargables', 200, 4, 1),
(26, 1, 'Laptop Dell Inspiron', 'Laptop de 15 pulgadas, 16GB RAM, SSD 512GB', 15, 1, 0),
(27, 2, 'Monitor LG 24\"', 'Monitor Full HD de 24 pulgadas', 20, 3, 1),
(28, 3, 'Teclado Mecánico RGB', 'Teclado con retroiluminación RGB', 30, 10, 1),
(29, 4, 'Mouse Inalámbrico', 'Mouse ergonómico con batería recargable', 50, 9, 1),
(30, 5, 'Impresora Brother', 'Impresora láser monocromática', 10, 7, 1),
(31, 6, 'Cartucho Brother TN-450', 'Cartucho de tóner negro', 100, 8, 1),
(32, 7, 'Router WiFi 6', 'Router de alta velocidad con soporte WiFi 6', 25, 9, 1),
(33, 8, 'SSD 500GB', 'Disco sólido de 500GB, alta velocidad', 40, 8, 1),
(34, 9, 'Pendrive 128GB', 'Memoria USB de 128GB, USB 3.0', 80, 4, 1),
(35, 10, 'Cámara Web 4K', 'Cámara web con resolución 4K', 15, 4, 1),
(36, 11, 'Auriculares Bluetooth', 'Auriculares inalámbricos con cancelación de ruido', 25, 8, 1),
(37, 12, 'Silla de Oficina', 'Silla ergonómica ajustable', 10, 10, 1),
(38, 13, 'Mesa Plegable', 'Mesa de madera plegable para oficina', 5, 3, 1),
(39, 14, 'Lámpara de Escritorio', 'Lámpara LED regulable', 30, 5, 1),
(40, 15, 'Papel Carta', 'Paquete de 500 hojas de papel blanco', 100, 7, 1),
(41, 16, 'Bolígrafo Pilot', 'Bolígrafo de tinta gel negro', 300, 9, 1),
(42, 17, 'Cuaderno Rayado', 'Cuaderno de 100 hojas rayadas', 50, 5, 1),
(43, 18, 'Carpeta Archivadora', 'Carpeta de 3 anillos para archivar', 40, 7, 1),
(44, 19, 'Calculadora Científica', 'Calculadora con funciones científicas', 20, 10, 1),
(45, 20, 'Proyector LED', 'Proyector portátil con resolución HD', 5, 10, 1),
(46, 21, 'Pizarra Magnética', 'Pizarra de 90x60 cm con superficie magnética', 10, 6, 1),
(47, 22, 'Marcador Borrable', 'Marcador para pizarra, color negro', 60, 10, 1),
(48, 23, 'Cargador USB-C', 'Cargador rápido USB-C de 20W', 70, 3, 1),
(49, 24, 'Cable USB 2m', 'Cable USB de 2 metros para datos y carga', 50, 4, 1),
(50, 25, 'Batería AAA', 'Paquete de 4 baterías AAA recargables', 200, 1, 1),
(51, 1, 'Laptop ASUS VivoBook', 'Laptop ligera, 8GB RAM, SSD 256GB', 12, 3, 1),
(52, 2, 'Monitor AOC 22\"', 'Monitor LED de 22 pulgadas', 18, 1, 1),
(53, 3, 'Teclado Silencioso', 'Teclado de membrana silencioso', 35, 7, 1),
(54, 4, 'Mouse Óptico USB', 'Mouse con cable, 1200 DPI', 60, 10, 1),
(55, 5, 'Impresora Canon', 'Impresora multifunción a color', 8, 7, 1),
(56, 6, 'Cartucho Canon PG-50', 'Cartucho de tinta negra', 90, 4, 1),
(57, 7, 'Extensor WiFi', 'Extensor de señal WiFi de doble banda', 20, 10, 1),
(58, 8, 'HDD 2TB', 'Disco duro externo de 2TB', 15, 8, 1),
(59, 9, 'Pendrive 32GB', 'Memoria USB de 32GB, USB 2.0', 100, 8, 1),
(60, 10, 'Cámara Web HD', 'Cámara web con micrófono integrado', 25, 8, 1),
(61, 17, 'pp', 'N/A', 0, 4, 1);
...
CREATE TABLE `sigm_unidad_medicion` (
  `ID_UNIDAD_MEDICION` int NOT NULL,
  `DSC_NOMBRE` varchar(50) COLLATE utf8mb4_general_ci NOT NULL,
...
(23, 22, 'Prueba', 2, '$2b$10$tO2mkYwkbzSh7W2uIsZEE.qO/cZ7fqIiQ18ZREHod1dRwNqY37WCS', 1);
...
CREATE TABLE `sigt_salida` (
  ...
  `ID_USUARIO` int DEFAULT NULL,
  `DSC_DETALLE_SALIDA` text COLLATE utf8mb4_unicode_ci,
  `ESTADO` tinyint(1) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
(9, 22, 1, '2025-04-26 14:14:00', 9, 'Nueva nota', 1),
(10, 10, 11, '2025-03-10 00:00:00', 10, 'Detalles agregados desde el phpmyadmin', 0);
...
--
ALTER TABLE `sigm_categoria_producto`
  MODIFY `ID_CATEGORIA_PRODUCTO` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=27;

--
-- AUTO_INCREMENT de la tabla `sigm_colaborador`
--
ALTER TABLE `sigm_colaborador`
  MODIFY `ID_COLABORADOR` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=23;

--
-- AUTO_INCREMENT de la tabla `sigm_comprobante_pago`
--
ALTER TABLE `sigm_comprobante_pago`
  MODIFY `ID_COMPROBANTE_PAGO` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=31;

--
-- AUTO_INCREMENT de la tabla `sigm_cuenta_bancaria`
--
ALTER TABLE `sigm_cuenta_bancaria`
  MODIFY `ID_CUENTA_BANCARIA` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=31;
...
--
ALTER TABLE `sigm_entidad_financiera`
  MODIFY `ID_ENTIDAD_FINANCIERA` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=32;

--
-- AUTO_INCREMENT de la tabla `sigm_factura`
--
ALTER TABLE `sigm_factura`
  MODIFY `ID_FACTURA` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=36;

--
-- AUTO_INCREMENT de la tabla `sigm_producto`
--
ALTER TABLE `sigm_producto`
  MODIFY `ID_PRODUCTO` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=62;

--
-- AUTO_INCREMENT de la tabla `sigm_proveedor`
--
ALTER TABLE `sigm_proveedor`
  MODIFY `ID_PROVEEDOR` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=22;

--
-- AUTO_INCREMENT de la tabla `sigm_puesto_trabajo`
--
ALTER TABLE `sigm_puesto_trabajo`
  MODIFY `ID_PUESTO_TRABAJO` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
...
--
ALTER TABLE `sigt_factura_producto`
  MODIFY `ID_FACTURA_PRODUCTO` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=45;
...
--
ALTER TABLE `sigt_salida_producto`
  MODIFY `ID_SALIDA_PRODUCTO` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;
